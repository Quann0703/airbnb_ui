        ...
        <>
            ...
            <div className="flex justify-between items-center self-stretch">
                <div className="flex items-center gap-2">
                    ...
                    <DotIcon />
                    <div className="text-gray-600 font-inter text-sm leading-5">Privacy</div>
                    <DotIcon />

                    <div className="text-gray-600 font-inter text-sm leading-5">Terms</div>
                    <DotIcon />

                    <div className="text-gray-600 font-inter text-sm leading-5">Sitemap</div>
                </div>
